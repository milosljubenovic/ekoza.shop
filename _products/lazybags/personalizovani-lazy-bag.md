...
description: |
  ...
  Ovaj jedinstveni komad nameštaja sastoji se od 7 prilagodljivih delova koji se lako mogu prilagoditi vašim potrebama i preferencijama. Svaki deo je dizajniran tako da vam pruži maksimalnu udobnost i podršku, bilo da se odmarate, čitate ili gledate omiljeni film.
  
  ## Karakteristike proizvoda:
  
  - **Prilagodljiv dizajn**: Sastavljen od 7 delova koji se mogu rasporediti na različite načine, omogućavajući vam da kreirate savršeno mesto za opuštanje.
  ...
  LazyBag je dostupan u četiri veličine (visina/osnova):
  ...
  - 300/130cm
images:
  - "/assets/images/products/personalizovani-lazy-bag/personalizovani-lazy-bag.png"
colors:
  - name: "Standardna"
    hex: "#808080"
    price_modifier: 0
